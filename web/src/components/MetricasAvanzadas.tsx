...
type Metrica = { etiqueta: string; valor: number | null; formatear: (v: number) => string };
  ...
  return [
    {
      ...
      metricas: [
        ...
        { etiqueta: "Deuda neta / EBITDA", valor: m.deuda_neta_ebitda, formatear: formatX },
      ],
    },
    {
      titulo: "Rentabilidad",
      metricas: [
        ...
        { etiqueta: "Margen EBIT", valor: m.margen_ebit_pct, formatear: formatPctPlano },
        { etiqueta: "ROA", valor: m.roa_pct, formatear: formatPctPlano },
        { etiqueta: "ROE", valor: m.roe_pct, formatear: formatPctPlano },
        { etiqueta: "ROIC (aprox.)", valor: m.roic_pct, formatear: formatPctPlano },
        { etiqueta: "ROCE", valor: m.roce_pct, formatear: formatPctPlano },
      ],
    },
    {
      titulo: "Valoración",
      metricas: [
        { etiqueta: "P/E", valor: m.pe, formatear: formatX },
        ...
        { etiqueta: "Dividend yield", valor: m.dividend_yield_pct, formatear: formatPctPlano },
        { etiqueta: "Payout ratio", valor: m.payout_ratio_pct, formatear: formatPctPlano },
      ],
    },
    {
      titulo: "Riesgo",
      metricas: [
        ...
        { etiqueta: "Beta (propio, vs. VOO)", valor: m.beta, formatear: (v) => formatNumeroCL(v, 2) },
      ],
    },
  ];
}
